namespace KiepCommunication.GUI
{
  partial class frmSettings
  {
    ...
    private void InitializeComponent()
    {
        ...
        this.btnNextWord = new KiepCommunication.GUI.MostButton();
        this.btnAutoComplete = new KiepCommunication.GUI.MostButton();
        this.btnYesNoDisplayTime = new KiepCommunication.GUI.MostButton();
        this.btnUnderscoreSpace = new KiepCommunication.GUI.MostButton();
        this.btnScanTime = new KiepCommunication.GUI.MostButton();
        this.SuspendLayout();
        // 
        // pnlControls
        // 
    ...
    private KiepCommunication.GUI.MostButton btnNextWord;
    private KiepCommunication.GUI.MostButton btnAutoComplete;
    private KiepCommunication.GUI.MostButton btnYesNoDisplayTime;
    private KiepCommunication.GUI.MostButton btnUnderscoreSpace;
    private KiepCommunication.GUI.MostButton btnScanTime;
  }
}