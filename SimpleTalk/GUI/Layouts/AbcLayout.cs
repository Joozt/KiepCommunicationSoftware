    ...
    class AbcLayout : CustomLayout
    {
        ...
        override public void ConstructLayout()
        {
          ...
          NewRow(
            ...
            NewButtons.Add(new ButtonDefinition("MENU", "&menu", new Size(Width + 20, _DefaultHeight), false));
            NewButtons.Add(new ButtonDefinition("OUD", "&history", new Size(Width + 20, _DefaultHeight), false));
